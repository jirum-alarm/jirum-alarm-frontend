          ...
          <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            ...
            <div className="p-2">
              <div className="grid gap-2">
                <button
                  type="button"
                  className="h-12 duration-200 border border-gray-200 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold relative"
                >
                  <svg
                    width="32"
                    height="32"
                ...
                <a
                  href={`https://kauth.kakao.com/oauth/authorize?client_id=4807ed026ae596e8ae795dfb4c8e4684&redirect_uri=https://jirum-api.kyojs.com/login/kakao&response_type=code`}
                >
                  <button
                    type="button"
