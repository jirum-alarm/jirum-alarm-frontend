    ...
    <Card>
      ...
      <div className="mt-10 flex w-full justify-end">
        <div className="flex gap-2">
          <button className="rounded-lg bg-red p-3 text-white">리셋</button>
          <button className=" rounded-lg border border-graydark bg-transparent p-3">등록</button>
        </div>
      </div>
    </Card>
  );
...
export default SynonymRegister;
