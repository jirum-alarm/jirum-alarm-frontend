...
async function HomeContainerV2() {
  ...
  return (
    <div className="pc:max-w-none pc:pb-0 max-w-mobile-max mx-auto h-full w-full overflow-x-hidden pb-8">
      ...
      <main className="pc:mt-[770px] pc:w-full pc:max-w-none pc:rounded-t-[1.75rem] pc:pt-[72px] max-w-mobile-max bg-surface-default relative z-10 mt-[160px] rounded-t-[1.25rem] pt-3">
