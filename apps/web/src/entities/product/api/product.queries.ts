...
export const ProductQueries = {
    ...
    queryOptions({
      queryKey: [
        ...ProductQueries.all(),
        {
          ...
          providerIds: variables.providerIds,
  ...
  clusteredProducts: (variables: { id: number }) =>
    queryOptions({
      queryKey: [...ProductQueries.all(), 'detail', { id: variables.id }, 'clustered'],
      queryFn: () => ProductService.getClusteredProducts(variables),
    }),

  sameProductDeals: (variables: { id: number }) =>
    queryOptions({
      queryKey: [...ProductQueries.all(), 'detail', { id: variables.id }, 'same-product'],
