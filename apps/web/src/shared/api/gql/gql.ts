...
const documents: Documents = {
  ...
  '\n  query QueryHotDealRankingProducts($page: Int!, $limit: Int!) {\n    hotDealRankingProducts(page: $page, limit: $limit) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n    }\n  }\n':
    types.QueryHotDealRankingProductsDocument,
  '\n  query QueryGuestRecommendedHotDeals($page: Int!, $limit: Int!) {\n    guestRecommendedHotDeals(page: $page, limit: $limit) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n    }\n  }\n':
    types.QueryGuestRecommendedHotDealsDocument,
  '\n  query QueryExpiringSoonHotDealProducts(\n    $daysUntilExpiry: Int!\n    $limit: Int!\n    $searchAfter: [String!]\n  ) {\n    expiringSoonHotDealProducts(\n      daysUntilExpiry: $daysUntilExpiry\n      limit: $limit\n      searchAfter: $searchAfter\n    ) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n      earliestExpiryDate\n    }\n  }\n':
    types.QueryExpiringSoonHotDealProductsDocument,
  '\n  query QueryTossCategoryLabels {\n    tossCategoryLabels\n  }\n':
    types.QueryTossCategoryLabelsDocument,
  '\n  query QueryTossProducts(\n    $limit: Int!\n    $searchAfter: [String!]\n    $keyword: String!\n    $orderBy: KeywordProductOrderType!\n    $orderOption: OrderOptionType!\n    $tossCategoryLabel: String\n  ) {\n    productsByKeyword(\n      limit: $limit\n      searchAfter: $searchAfter\n      keyword: $keyword\n      orderBy: $orderBy\n      orderOption: $orderOption\n      tossCategoryLabel: $tossCategoryLabel\n    ) {\n      id\n      title\n      price\n      thumbnail\n      data\n      searchAfter\n      postedAt\n    }\n  }\n':
    types.QueryTossProductsDocument,
  '\n  mutation AddWishlist($productId: Int!) {\n    addWishlist(productId: $productId)\n  }\n':
...
export function graphql(
  source: '\n  mutation AddCommunityPost($content: String!, $title: String, $productId: Int) {\n    addComment(content: $content, title: $title, productId: $productId)\n  }\n',
): typeof import('./graphql').AddCommunityPostDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
  source: '\n  mutation RemoveCommunityPost($id: Int!) {\n    removeComment(id: $id)\n  }\n',
): typeof import('./graphql').RemoveCommunityPostDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
  source: '\n  mutation LikeCommunityPost($targetId: Int!, $isLike: Boolean) {\n    addUserLikeOrDislike(target: COMMENT, targetId: $targetId, isLike: $isLike)\n  }\n',
): typeof import('./graphql').LikeCommunityPostDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
...
export function graphql(
  source: '\n  query QueryHotDealRankingProducts($page: Int!, $limit: Int!) {\n    hotDealRankingProducts(page: $page, limit: $limit) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n    }\n  }\n',
): typeof import('./graphql').QueryHotDealRankingProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: '\n  query QueryGuestRecommendedHotDeals($page: Int!, $limit: Int!) {\n    guestRecommendedHotDeals(page: $page, limit: $limit) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n    }\n  }\n',
): typeof import('./graphql').QueryGuestRecommendedHotDealsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: '\n  query QueryExpiringSoonHotDealProducts(\n    $daysUntilExpiry: Int!\n    $limit: Int!\n    $searchAfter: [String!]\n  ) {\n    expiringSoonHotDealProducts(\n      daysUntilExpiry: $daysUntilExpiry\n      limit: $limit\n      searchAfter: $searchAfter\n    ) {\n      id\n      title\n      mallId\n      url\n      isHot\n      isEnd\n      price\n      providerId\n      categoryId\n      category\n      thumbnail\n      hotDealType\n      provider {\n        nameKr\n      }\n      searchAfter\n      postedAt\n      earliestExpiryDate\n    }\n  }\n',
): typeof import('./graphql').QueryExpiringSoonHotDealProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: '\n  query QueryTossCategoryLabels {\n    tossCategoryLabels\n  }\n',
): typeof import('./graphql').QueryTossCategoryLabelsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: '\n  query QueryTossProducts(\n    $limit: Int!\n    $searchAfter: [String!]\n    $keyword: String!\n    $orderBy: KeywordProductOrderType!\n    $orderOption: OrderOptionType!\n    $tossCategoryLabel: String\n  ) {\n    productsByKeyword(\n      limit: $limit\n      searchAfter: $searchAfter\n      keyword: $keyword\n      orderBy: $orderBy\n      orderOption: $orderOption\n      tossCategoryLabel: $tossCategoryLabel\n    ) {\n      id\n      title\n      price\n      thumbnail\n      data\n      searchAfter\n      postedAt\n    }\n  }\n',
): typeof import('./graphql').QueryTossProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
