...
const defaultStyles: Required<TabBarStyles> = {
  container:
    'fixed w-full max-w-mobile-max pc:max-w-none pc:sticky top-14 pc:top-14 z-30 overflow-hidden bg-white pl-4 pr-12 transition-transform pc:pr-4 pt-3 pb-3 pc:pb-2',
