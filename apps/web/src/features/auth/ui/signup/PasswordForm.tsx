...
import usePasswordFormViewModel from '../../model/signup/usePasswordFormViewModel';
...
const PasswordForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-1 flex-col justify-between pt-22">
      ...
      />
      <div className="h-32" />
      <div className="bg-surface-default fixed right-0 bottom-0 left-0 m-auto w-full max-w-[600px] px-5 pt-3 pb-9">
