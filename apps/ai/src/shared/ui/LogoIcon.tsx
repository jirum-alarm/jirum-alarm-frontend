/** apps/web 헤더의 최신 로고(shared/ui/common/icons/Illust/IconLogo.tsx)와 동일 SVG. */
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          />
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_ai_logo" />
        </filter>
      </defs>
    </svg>
  );
